...
class ChefTest < ActiveSupport::TestCase
  ...
  test "email length should be within bounce" do
  ...
  test "eamil validation should accept valid address" do
    valid_address = %w[user@eee.com R_TDD-DS@eee.hello.org user@example.com first.last@eem.au laura+joe@onk.cm]
   ...
   test "eamil validation should reject invalid address" do
